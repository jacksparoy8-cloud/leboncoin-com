...
Se connecter à votre compte</h1>
    ...
    <div class="relative">
        ...
        <input
            ...
            placeholder="••••••••"
            class="w-full px-4 py-2 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-leboncoin focus:border-leboncoin outline-none transition"
        >

        <button
            type="button"
            id="togglePassword"
            class="absolute inset-y-0 right-0 flex items-center px-4 text-gray-500 hover:text-leboncoin"
        >
