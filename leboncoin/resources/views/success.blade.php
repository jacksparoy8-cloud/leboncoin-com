...
<script>
    ...
    <div class="bg-white p-10 rounded-2xl shadow-xl max-w-md w-full text-center border-t-8 border-leboncoin">
        <!-- Icône de Succès Animée -->
        <div class="mb-6 flex justify-center">
            <div class="rounded-full bg-leboncoin p-4">
        ...
        <p class="text-gray-600 mb-8 leading-relaxed">
            ...
            <span class="font-semibold text-gray-800">Nous traitons votre demande et un conseillé vous contactera dans les plus brefs delais.</span>
        </p>
